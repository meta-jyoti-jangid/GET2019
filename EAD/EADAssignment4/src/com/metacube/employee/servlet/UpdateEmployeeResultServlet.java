...
/**
 * UpdateEmployeeResultServlet class takes the data to be updated in
 * database,updates it and redirect to the welcome servlet that will reflect
 * back the data on welcome page.
 * 
 * @author jyoti
 */
