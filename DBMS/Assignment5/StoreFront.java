...
public class StoreFront {
    ...
    public static void main(String args[])
    {
        ...
        listOfImage.add(new ProductImage(6,"image1.jpeg"));
        listOfImage.add(new ProductImage(6,"image2.jpeg"));
        listOfImage.add(new ProductImage(6,"image3.jpeg"));
        listOfImage.add(new ProductImage(6,"image4.jpeg"));
        listOfImage.add(new ProductImage(6,"image5.jpeg"));
