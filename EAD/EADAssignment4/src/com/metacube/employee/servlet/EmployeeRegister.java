...
/**
 * EmployeeRegister class registers the employee in the database with a unique
 * id.
 * 
 * @author jyoti
 */
public class EmployeeRegister extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if (empName != null && empEmail != null && empContact != null
					&& empGender != null && empPassword != null
				...
				if (result != -1) {
					...
					RequestDispatcher rd = req
							.getRequestDispatcher("/vehicleRegister.jsp");
					rd.include(req, res);
					rd.forward(req, res);
				} else {
