...
public class StringOperations {
	...
	public static void main(String[] args) throws Exception {
		StringOperations n = new StringOperations();
		System.out.println(n.compareTo("hello", "hello"));
		System.out.println(n.Reverse("workHard"));
		System.out.println(n.largest_word("god id great"));
		System.out.println(n.ToggleString("HELLO"));
	}
