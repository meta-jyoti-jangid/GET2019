...
public class CalculateMolWeight {
	...
	public static void main(String args[]) {
		...
		System.out.println("mass of ch3(ch3coh) :"+mass.evaluate("ch3(ch3coh)"));
		System.out.println("mass of ch3 :"+mass.evaluate("ch3"));
		System.out.println("mass of ch3oh :"+mass.evaluate("ch3oh"));
		System.out.println("mass of ch3cooh :"+mass.evaluate("ch3cooh"));
