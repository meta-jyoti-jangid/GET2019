...
import POJO.EmployeeVehicle;
import POJO.Friends;
import POJO.Employee;

/**
 * RetrieveEmployeeData class is a database connector class that will retrieve
 * Students data.
 *
 * @author jyoti
 */
public class RetrieveEmployeeData {
	...
	/**
	 * Constructor to initialize List of all the Employees and connection with
	 * the database.
	 */
	 ...
	 *         collectAllEmployeeFriendsData method retrieves data of all the
	 *         friends of the particular employee
	 */
	public List<Friends> collectAllEmployeeFriendsData(String organization,
			int id) {
